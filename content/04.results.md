...
As an alternate approach, we tried including/excluding entire genes using similar filters; results are shown in Supplementary Figure {@fig:all_volcano_filter}.
