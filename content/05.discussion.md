...
Based on our results, for studies focused on the functional consequences of cancer mutations, we recommend using gene expression and/or DNA methylation as downstream readouts.
On balance, prediction of mutation status was slightly better using gene expression data.
However, the finding that DNA methylation profiles contain much of the same information will be useful for some study designs, given the varying stability of mRNA across different nucleotide sequences and experimental conditions.
