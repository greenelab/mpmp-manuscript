...
The top row shows the five cancer types with the highest average coefficient of variation (i.e. best precision) across data types, for expression, 27K methylation, and 450K methylation.
The bottom row shows the five cancer types with the highest average coefficient of variation (i.e. best precision) across data types, for the comparison using all 6 data types.
