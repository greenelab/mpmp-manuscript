...
However, sampling randomly with respect to labels may generate train and test sets with varying label proportions, which presents its own challenges.
...
For such genes, our cross-validation procedure may occasionally randomly partition a training or test fold that contains no mutated samples.
