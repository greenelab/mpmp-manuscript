...
### Cancer gene data download and integration
...
The individual gene sets we integrated were from Vogelstein et al. 2013 [@doi:10.1126/science.1235122] (all genes from Table S2A), Bailey et al. 2018 [@doi:10.1016/j.cell.2018.02.060] (only genes annotated as "pan-cancer" drivers in Table S1), and the COSMIC Cancer Gene Census [@doi:10.1038/s41568-018-0060-1] (all Tier 1 genes annotated as "somatic").
